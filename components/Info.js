        ...
        <div className={styles.info_container} >
                ...
                <div className={styles.rate}>
                    <div className={styles.rating}>
                        ...
                        <div className={styles.value}>
                            ...
                            {x.vote_average ? x.vote_average : "0.0"}/<span className={styles.spann}>10</span>
                        </div>
                    </div>
                    <div className={styles.your_rating}>
                        <div className={styles.heading}>Your Rating</div>
                        <div className={styles.value}>
                            <span className="text-blue-500"><BsStar /></span>
                        </div>
                    </div>
                    <div className={styles.popularity}>
                        <div className={styles.heading}>Popularity</div>
                        <div className={styles.value}>
                            <span className="pr-2 text-green-500"><FaChartLine /></span>
            ...
            <div className={styles.mid}>
                <div className={styles.image}>
                    <img src={`${image_base}${x.poster_path}`} className={styles.imggg} alt="poster" />
                </div >
                <div className={styles.video}>
                    <div id="thumbnail" className={styles.thumbnail} onClick={playVideoHandler} >
                        <div className={styles.image}>
                            <img src={image_base + x.backdrop_path} className={styles.imag} />
                        </div >
                        <div className={styles.overlay}>
                            <span className={styles.fas}><FaPlayCircle /></span>
                            Play Trailer
                        </div >
                    </div >
                ...
                <div className={styles.overview}>
                    <div className={styles.heading}>
                        <div className="flex items-center">
                            ...
                            <span className={styles.fas}><FaChevronRight /></span>
                        </div>
                    </div >
                    ...
                    <div className={styles.details}>
                        {cast.map((cast) => (
                            <div className={styles.card} key={cast.original_name}>
                                <div className={styles.image}>
                                    <img className={styles.images} src={cast.profile_path ? image_base + cast.profile_path
                                        : "https://www.chocolatebayou.org/wp-content/uploads/No-Image-Person-1536x1536.jpeg"}
                                        alt="cast-image" />
                                </div >
                                <div className={styles.position}>
                                    {cast.original_name} <span className="spannnn" > as {cast.character}</span >
                                </div >
                            </div >
                        ))
                        }
