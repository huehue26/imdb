    ...
    <div className={styles.slideshow}>
      ...
      {!load && imageLoaded ? (
        <div className={styles.details}>
          <p className={styles.title}>{show_details.original_title}</p>
          <p className={styles.discription}>{show_details.overview}</p>
      ...
      {!load && imageLoaded ? (
        <div className={styles.next_shows}>
          <div>
            <Image
              src={show_image_next_1}
              alt="slideshow_next_image"
