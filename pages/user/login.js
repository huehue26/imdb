...
function Login() {
    ...
    return (
        <div className="h-screen w-screen overflow-hidden bg-zinc-900  flex justify-center items-center">
            ...
            <div className="h-96 w-96 rounded-2xl mt-1/2 mx-auto bg-zinc-800 flex justify-center items-center">
                <div className="pl-8">
                    <div className="text-4xl font-bold pb-10 flex justify-center items-center text-yellow-500">Log In</div>
                    ...
                    {err ? (
                        <div className="text-red-600 text-sm pt-2">{err}</div>
                    ) : ""}
                    <div className="flex justify-center items-center">
                        <button className="bg-yellow-500 text-gray-100 h-30 w-36 mt-9 p-3 rounded-lg hover:bg-yellow-600" onClick={loginHandler}>
                            Log In
                        </button>
                    </div>
                    ...
                    <div className="flex justify-center items-center">
                        <div className="text-sky-600 flex justify-center items-center p-4">
                            <FaFacebook size={40} />
                        </div>
                        <div className="flex justify-center items-center p-4">
                            <FcGoogle size={40} />
                        </div>
                        <div className="text-blue-500 flex justify-center items-center p-4">
